DYNAC V8 (WINDOWS and LINUX/MAC versions)                         16-Dec-2025
...
DYNAC developers (main developer: Eugene Tanke) regarding 
...
MAC SPECIFIC:
After installing gfortran, you will also need to install MAC OS Xcode developer. 
...
Make sure to choose the correct architecure (X86_64) and win32 threads. Once
...
set PATH=%PATH%;C:\dynacv8_w\bin
setx PATH "%PATH%;C:\dynacv8_w\bin"
...
type comv8 in the case of WINDOWS.
On linux/MAC you may have to render comv8 executable by typing
chmod u+x comv8
...
need to add -ffloat-store as compiler flag in the comv8 script.
...
complt
On linux/MAC you may have to render comv8 executable first by typing
...
dynacv8 sns_mebt_dtl1.in
or
dynacv8 egun_example2.in
...
It points to the dynplt executable located in dynac/bin
...
the source code, the plotting program dynplt.f08 and the user guide. They can
